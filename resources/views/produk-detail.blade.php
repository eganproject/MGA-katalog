        ...
        <div class="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-start">
            ...
            <div class="space-y-6">
                ...
                <div class="flex flex-wrap gap-3 pt-2">
                    <a href="https://wa.me/628212100183" class="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-brand-600 text-white font-semibold shadow-lg shadow-brand-500/30 hover:bg-brand-700 transition">

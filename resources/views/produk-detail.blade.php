        ...
        <div class="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-start">
            ...
            <div class="rounded-3xl p-4 md:p-6 relative overflow-visible">
                <div class="relative z-10 space-y-4">
                    ...
                    @endphp
                    <div id="main-image-wrapper" class="group relative bg-white rounded-2xl border border-slate-100 flex items-center justify-center overflow-hidden shadow-sm cursor-zoom-in w-full h-[320px] sm:h-[360px] md:h-[420px] lg:h-[451px] max-w-full mx-auto">
